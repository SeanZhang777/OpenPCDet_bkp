...
class PointPillar(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.map_to_bev = map_to_bev.__all__[self.model_cfg.MAP_TO_BEV.NAME](
            model_cfg=self.model_cfg.MAP_TO_BEV,
            grid_size=model_info_dict['grid_size']
        )
        model_info_dict['num_bev_features'] = self.map_to_bev.num_bev_features

        self.backbone_2d = backbones_2d.__all__[self.model_cfg.BACKBONE_2D.NAME](
            model_cfg=self.model_cfg.BACKBONE_2D,
            input_channels=model_info_dict['num_bev_features']
        )
        model_info_dict['num_bev_features'] = self.backbone_2d.num_bev_features

        self.dense_head = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
    ...
    def forward(self, voxels: torch.Tensor,
        ...
        input_list = self.vfe(voxels, voxel_num_points, coords)
        batch_spatial_features = self.map_to_bev(input_list)
