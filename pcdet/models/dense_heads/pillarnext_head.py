    ...
    def __init__(self, input_channels, sep_head_dict, init_bias=-2.19, use_bias=False):
        ...
        for cur_name in self.sep_head_dict:
            ...
            for k in range(num_conv - 1):
                fc_list.append(nn.Sequential(
                    nn.Conv2d(input_channels, 64, kernel_size=3, stride=1, padding=1, bias=use_bias),
                    nn.BatchNorm2d(64),
                    nn.ReLU()
                ))
            fc_list.append(nn.Conv2d(64, output_channels, kernel_size=3, stride=1, padding=1, bias=True))
...
class PillarNeXtHead(nn.Module):
    ...
    def get_loss(self):
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            if self.iou_branch:
                ...
                loss += (hm_loss + loc_loss + iou_reg_loss)
    ...
    def forward(self, data_dict):
        ...
        for head in self.heads_list:
            pred_dicts.append(head(spatial_features_2d))
