...
def get_objects_from_label(label_file, type_to_id=None):
...
class Object3d(object):
    def __init__(self, line, type_to_id=None):
        ...
        # self.box2d = np.array((0.0, 0.0, 0.0, 0.0))
    ...
    def to_neolix_format(self):
        neolix_str = '%s %.2f %d %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f' \
